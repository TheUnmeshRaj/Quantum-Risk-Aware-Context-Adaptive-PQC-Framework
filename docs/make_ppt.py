...
txt(s, "UNISYS", 1, 1.2, 11, 1, size=60, bold=True, color=BLUE_ACC, align=PP_ALIGN.CENTER)
...
txt(s, "UNISYS", 1, 1.8, 11, 1.2, size=64, bold=True, color=BLUE_ACC, align=PP_ALIGN.CENTER)
...
prs.save("UNISYS_PQC_Framework_Presentation.pptx")
print("Saved: UNISYS_PQC_Framework_Presentation.pptx")
